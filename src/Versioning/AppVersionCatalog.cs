...
public static class AppVersionCatalog
{
    ...
    [
        new(
            CurrentVersion,
            "21 сентября 2026",
            "0.0.5: расширенная гексагональная карта, океан/озёра/реки, пустыни и рельеф; у каждого гекса есть влажность, температура, высота, давление и скорость движения.",
            "Текущая разработка",
            true),
        new(
            PreviousVersion,
